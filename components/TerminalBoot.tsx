...
const bootMessages = [
  ...
  '[OK] CPU inicializada',
  '[OK] Memoria RAM: 16GB disponible',
  '[OK] Sistema de archivos montado',
  '[OK] Controladores de red cargados',
  '[OK] Interfaz grafica iniciada',
  '',
  'Preparando experiencia de usuario...',
  '[OK] Componentes UI cargados',
  '[OK] Animaciones activadas',
  '[OK] Sistema de ventanas listo',
  '',
